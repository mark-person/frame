...
public class AccessEntity {
    ...
    public ExceptionPojo getE() {
        return e;
    }

    public void setE(ExceptionPojo e) {
        this.e = e;
    }
    ...
    public static AccessEntity getInstance(AccessLog a) {
        ...
        if (a.getThrowable() != null) {
            ExceptionPojo error = ExceptionUtils.getErroCode(a.getThrowable());
            error.setMsg(a.getThrowable().getClass().getSimpleName());
            entity.setE(error);
        }
