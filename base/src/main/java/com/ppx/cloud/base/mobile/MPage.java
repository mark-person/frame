...
public class MPage {
    ...
    public void setPageSize(int pageSize) {
		if (pageSize > MAX_PAGE_SIZE) {
			throw new SecurityException("PARAM_OUT_OF_PAGE_SIZE pageSize:" + pageSize);
		}
	...
	public String getOrderName() {
		if (!StringUtils.isEmpty(orderName) && !permitOrderNameSet.contains(orderName)) {
			throw new SecurityException("PARAM_OUT_OF_ORDER orderName:" + orderName);
		}
		return orderName;
	}
	...
	public void setOrderType(String orderType) {
		if (StringUtils.isEmpty(orderType) || "desc".equals(orderType) || "asc".equals(orderType)) {
			...
			throw new SecurityException("PARAM_OUT_OF_ORDER orderType:" + orderType);
		}
	}
