package com.ppx.cloud.base.jdbc;
...
import com.ppx.cloud.base.jdbc.annotation.Column;
import com.ppx.cloud.base.jdbc.annotation.Id;
import com.ppx.cloud.base.jdbc.annotation.Table;
...
//	}
	...
	private int updateNoUnique(Object bean, LimitRecord limitRecord) {
		...
		if (idObj == null) {
			throw new ErrorException(ExceptionCode.ERROR_JAVA, "JdbcUpdateNoPk");
		}
	 ...
	 * @return 返回对List<对象>
	 */
	protected <T> List<T> queryForPage(Class<T> c, Page page, StringBuilder cSql, StringBuilder qSql,
	...
	protected List<Map<String, Object>> queryForPage(Page page, StringBuilder cSql, StringBuilder qSql,
			List<Object> paraList) {
		...
		return super.getJdbcTemplate().queryForList(qSql.toString(), paraList.toArray());
	}

	protected <T> List<T> queryForPage(Class<T> c, Page page, StringBuilder cSql, StringBuilder qSql) {
		return queryForPage(c, page, cSql, qSql, null);
	}
